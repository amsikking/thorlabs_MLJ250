...
class Controller:
    '''
    Basic device adaptor for Thorlabs MLJ250 motorized high-load vertical
    ...
    def __init__(self,
        ...
        assert self._get_model_number() == 'MLJ250'
...
if __name__ == '__main__':
    controller = Controller(
        which_port='COM17', verbose=True, very_verbose=False)
